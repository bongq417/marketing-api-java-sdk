...
public class QuerywordRptApi {
  private ApiClient apiClient;

  public QuerywordRptApi() {
    this(Configuration.getDefaultApiClient());
  }

  public QuerywordRptApi(ApiClient apiClient) {
  ...
  /**
   * Build call for querywordRptGet
   *
   * @param data (required)
   ...
   */
  public okhttp3.Call querywordRptGetCall(
    ...
    String localVarPath = "/queryword_rpt/get";
  ...
  private okhttp3.Call querywordRptGetValidateBeforeCall(
      QuerywordRptGetRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    if (data == null) {
      throw new ApiException(
          "Missing the required parameter 'data' when calling querywordRptGet(Async)");
    }
   ...
   */
  public okhttp3.Call querywordRptGetAsync(
