...
public class ProfilesApi {
   ...
   *     response body
   */
  public ProfilesGetResponse profilesGet(
      Long accountId,
      List<FilteringStruct> filtering,
      Long page,
      Long pageSize,
    ...
    ApiResponse<ProfilesGetResponse> resp =
        profilesGetWithHttpInfo(accountId, filtering, page, pageSize, fields);
    return resp.getData();
  }
   ...
   *     response body
   */
  public ApiResponse<ProfilesGetResponse> profilesGetWithHttpInfo(
      Long accountId,
      List<FilteringStruct> filtering,
      Long page,
      Long pageSize,
