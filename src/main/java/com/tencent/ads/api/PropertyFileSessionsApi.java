...
public class PropertyFileSessionsApi {
   ...
   */
  public okhttp3.Call propertyFileSessionsAddCall(
  ...
  private okhttp3.Call propertyFileSessionsAddValidateBeforeCall(
      PropertyFileSessionsAddRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
  ...
  public ApiResponse<PropertyFileSessionsAddResponse> propertyFileSessionsAddWithHttpInfo(
      PropertyFileSessionsAddRequest data) throws ApiException {
    okhttp3.Call call = propertyFileSessionsAddValidateBeforeCall(data, null, null);
   ...
   */
  public okhttp3.Call propertyFileSessionsAddAsync(
      PropertyFileSessionsAddRequest data,
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public okhttp3.Call propertyFileSessionsUpdateCall(
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call propertyFileSessionsUpdateValidateBeforeCall(
      PropertyFileSessionsUpdateRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
  ...
  public ApiResponse<PropertyFileSessionsUpdateResponse> propertyFileSessionsUpdateWithHttpInfo(
      PropertyFileSessionsUpdateRequest data) throws ApiException {
    okhttp3.Call call = propertyFileSessionsUpdateValidateBeforeCall(data, null, null);
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call propertyFileSessionsUpdateAsync(
      PropertyFileSessionsUpdateRequest data,
