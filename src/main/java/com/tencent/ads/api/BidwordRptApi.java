...
public class BidwordRptApi {
  private ApiClient apiClient;

  public BidwordRptApi() {
    this(Configuration.getDefaultApiClient());
  }

  public BidwordRptApi(ApiClient apiClient) {
  ...
  public okhttp3.Call bidwordRptGetCall(
    ...
    String localVarPath = "/bidword_rpt/get";
   ...
   *     response body
   */
  public BidwordRptGetResponse bidwordRptGet(BidwordRptGetRequest data) throws ApiException {
    ApiResponse<BidwordRptGetResponse> resp = bidwordRptGetWithHttpInfo(data);
    return resp.getData();
  }
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;BidwordRptGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
