...
public class BusinessPointApi {
   ...
   */
  public okhttp3.Call businessPointGetCall(
  ...
  private okhttp3.Call businessPointGetValidateBeforeCall(
      BusinessPointGetRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
  ...
  public ApiResponse<BusinessPointGetResponse> businessPointGetWithHttpInfo(
    ...
    okhttp3.Call call = businessPointGetValidateBeforeCall(data, null, null);
   ...
   */
  public okhttp3.Call businessPointGetAsync(
