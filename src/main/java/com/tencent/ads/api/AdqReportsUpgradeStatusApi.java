...
import com.tencent.ads.model.AdqReportsUpgradeStatusGetResponse;
...
public class AdqReportsUpgradeStatusApi {
  private ApiClient apiClient;

  public AdqReportsUpgradeStatusApi() {
    this(Configuration.getDefaultApiClient());
  }

  public AdqReportsUpgradeStatusApi(ApiClient apiClient) {
  ...
  /**
   * Build call for adqReportsUpgradeStatusGet
   *
   ...
   */
  public okhttp3.Call adqReportsUpgradeStatusGetCall(
      Long accountId,
      List<String> fields,
    ...
    String localVarPath = "/adq_reports_upgrade_status/get";
  ...
  private okhttp3.Call adqReportsUpgradeStatusGetValidateBeforeCall(
      Long accountId,
      List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling adqReportsUpgradeStatusGet(Async)");
    }
   ...
   * @param accountId (required)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;AdqReportsUpgradeStatusGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  /**
   * 获取腾讯广告平台广告账户升级状态 (asynchronously)
   *
   * @param accountId (required)
   * @param fields 返回参数的字段列表 (optional)
   ...
   */
  public okhttp3.Call adqReportsUpgradeStatusGetAsync(
      Long accountId,
      List<String> fields,
