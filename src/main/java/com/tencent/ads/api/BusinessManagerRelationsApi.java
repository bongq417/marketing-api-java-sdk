...
public class BusinessManagerRelationsApi {
   ...
   */
  public okhttp3.Call businessManagerRelationsGetCall(
      Long page,
      Long pageSize,
      Long advertiserType,
      List<String> fields,
  ...
  private okhttp3.Call businessManagerRelationsGetValidateBeforeCall(
      Long page,
      Long pageSize,
      Long advertiserType,
      List<String> fields,
   ...
   */
  public okhttp3.Call businessManagerRelationsGetAsync(
      Long page,
      Long pageSize,
      Long advertiserType,
      List<String> fields,
