...
public class AdAppealQuotaApi {
  private ApiClient apiClient;

  public AdAppealQuotaApi() {
    this(Configuration.getDefaultApiClient());
  }

  public AdAppealQuotaApi(ApiClient apiClient) {
  ...
  /**
   * Build call for adAppealQuotaGet
   *
   * @param data (required)
  ...
  public okhttp3.Call adAppealQuotaGetCall(
    ...
    String localVarPath = "/ad_appeal_quota/get";
   ...
   *     response body
   */
  public AdAppealQuotaGetResponse adAppealQuotaGet(AdAppealQuotaGetRequest data)
      throws ApiException {
    ApiResponse<AdAppealQuotaGetResponse> resp = adAppealQuotaGetWithHttpInfo(data);
    return resp.getData();
  }
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;AdAppealQuotaGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
