...
public class BatchAsyncRequestSpecificationApi {
  private ApiClient apiClient;

  public BatchAsyncRequestSpecificationApi() {
    this(Configuration.getDefaultApiClient());
  }

  public BatchAsyncRequestSpecificationApi(ApiClient apiClient) {
  ...
  /**
   * Build call for batchAsyncRequestSpecificationGet
   *
  ...
  public okhttp3.Call batchAsyncRequestSpecificationGetCall(
    ...
    String localVarPath = "/batch_async_request_specification/get";
  ...
  private okhttp3.Call batchAsyncRequestSpecificationGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling batchAsyncRequestSpecificationGet(Async)");
    }
   ...
   *     response body
   */
  public BatchAsyncRequestSpecificationGetResponse batchAsyncRequestSpecificationGet(
    ...
    ApiResponse<BatchAsyncRequestSpecificationGetResponse> resp =
        batchAsyncRequestSpecificationGetWithHttpInfo(accountId, taskId, page, pageSize, fields);
    return resp.getData();
  }
   ...
   * @param pageSize (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;BatchAsyncRequestSpecificationGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  public ApiResponse<BatchAsyncRequestSpecificationGetResponse>
    ...
    Type localVarReturnType =
        new TypeToken<BatchAsyncRequestSpecificationGetResponse>() {}.getType();
    return apiClient.execute(call, localVarReturnType);
  }

  /**
   * 获取批量异步请求任务详情 (asynchronously)
   *
   * @param accountId (required)
   * @param taskId (required)
   * @param page (optional)
