...
public class ObjectCommentFlagApi {
  private ApiClient apiClient;

  public ObjectCommentFlagApi() {
    this(Configuration.getDefaultApiClient());
  }

  public ObjectCommentFlagApi(ApiClient apiClient) {
  ...
  /**
   * Build call for objectCommentFlagUpdate
   *
   * @param data (required)
  ...
  public okhttp3.Call objectCommentFlagUpdateCall(
    ...
    String localVarPath = "/object_comment_flag/update";
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;ObjectCommentFlagUpdateResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
