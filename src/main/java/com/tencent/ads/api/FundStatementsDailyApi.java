...
public class FundStatementsDailyApi {
  private ApiClient apiClient;

  public FundStatementsDailyApi() {
    this(Configuration.getDefaultApiClient());
  }

  public FundStatementsDailyApi(ApiClient apiClient) {
  ...
  public okhttp3.Call fundStatementsDailyGetCall(
    ...
    String localVarPath = "/fund_statements_daily/get";
  ...
  private okhttp3.Call fundStatementsDailyGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling fundStatementsDailyGet(Async)");
    }

    // verify the required parameter 'fundType' is set
    if (fundType == null) {
      throw new ApiException(
          "Missing the required parameter 'fundType' when calling fundStatementsDailyGet(Async)");
    }
   ...
   *     response body
   */
  public FundStatementsDailyGetResponse fundStatementsDailyGet(
      Long accountId, String fundType, DateRange dateRange, String tradeType, List<String> fields)
      throws ApiException {
    ApiResponse<FundStatementsDailyGetResponse> resp =
        fundStatementsDailyGetWithHttpInfo(accountId, fundType, dateRange, tradeType, fields);
    return resp.getData();
  }
   ...
   * @param tradeType (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;FundStatementsDailyGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  public okhttp3.Call fundStatementsDailyGetAsync(
      ...
      String tradeType,
      List<String> fields,
      final ApiCallback<FundStatementsDailyGetResponse> callback)
      throws ApiException {
