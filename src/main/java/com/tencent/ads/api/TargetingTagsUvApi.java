...
public class TargetingTagsUvApi {
  private ApiClient apiClient;

  public TargetingTagsUvApi() {
    this(Configuration.getDefaultApiClient());
  }

  public TargetingTagsUvApi(ApiClient apiClient) {
  ...
  /**
   * Build call for targetingTagsUvGet
   *
  ...
  public okhttp3.Call targetingTagsUvGetCall(
    ...
    String localVarPath = "/targeting_tags_uv/get";
    ...
    if (categoryType != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("category_type", categoryType));
    if (categoryList != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("multi", "category_list", categoryList));
    if (fields != null)
  ...
  private okhttp3.Call targetingTagsUvGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling targetingTagsUvGet(Async)");
    }
   ...
   * @param categoryList (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;TargetingTagsUvGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
