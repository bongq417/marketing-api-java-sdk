...
public class CustomAudienceInsightsApi {
   ...
   */
  public okhttp3.Call customAudienceInsightsGetCall(
      Long accountId,
      Long audienceId,
    ...
    String localVarPath = "/custom_audience_insights/get";
    ...
    if (dimensionType != null)
      localVarCollectionQueryParams.addAll(
          apiClient.parameterToPairs("multi", "dimension_type", dimensionType));
    if (fields != null)
  ...
  private okhttp3.Call customAudienceInsightsGetValidateBeforeCall(
      Long accountId,
      Long audienceId,
      List<String> dimensionType,
      List<String> fields,
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling customAudienceInsightsGet(Async)");
    }

    // verify the required parameter 'audienceId' is set
    if (audienceId == null) {
      throw new ApiException(
          "Missing the required parameter 'audienceId' when calling customAudienceInsightsGet(Async)");
    }

    // verify the required parameter 'dimensionType' is set
    if (dimensionType == null) {
      throw new ApiException(
          "Missing the required parameter 'dimensionType' when calling customAudienceInsightsGet(Async)");
    }

    okhttp3.Call call =
        customAudienceInsightsGetCall(
            accountId,
            audienceId,
            dimensionType,
            fields,
   ...
   * @param dimensionType (required)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;CustomAudienceInsightsGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
   ...
   */
  public okhttp3.Call customAudienceInsightsGetAsync(
      Long accountId,
      Long audienceId,
      List<String> dimensionType,
      List<String> fields,
