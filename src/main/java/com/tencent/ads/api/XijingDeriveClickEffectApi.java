...
public class XijingDeriveClickEffectApi {
  private ApiClient apiClient;

  public XijingDeriveClickEffectApi() {
    this(Configuration.getDefaultApiClient());
  }

  public XijingDeriveClickEffectApi(ApiClient apiClient) {
  ...
  /**
   * Build call for xijingDeriveClickEffectGet
   *
   * @param data (required)
  ...
  public okhttp3.Call xijingDeriveClickEffectGetCall(
    ...
    String localVarPath = "/xijing_derive_click_effect/get";
   ...
   *     response body
   */
  public XijingDeriveClickEffectGetResponse xijingDeriveClickEffectGet(
      XijingDeriveClickEffectGetRequest data) throws ApiException {
    ApiResponse<XijingDeriveClickEffectGetResponse> resp =
        xijingDeriveClickEffectGetWithHttpInfo(data);
    return resp.getData();
  }
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;XijingDeriveClickEffectGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
