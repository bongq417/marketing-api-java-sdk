...
public class ReviewElementPrereviewResultsApi {
  private ApiClient apiClient;

  public ReviewElementPrereviewResultsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public ReviewElementPrereviewResultsApi(ApiClient apiClient) {
  ...
  /**
   * Build call for reviewElementPrereviewResultsGet
   *
   * @param data (required)
   ...
   */
  public okhttp3.Call reviewElementPrereviewResultsGetCall(
    ...
    String localVarPath = "/review_element_prereview_results/get";
  ...
  private okhttp3.Call reviewElementPrereviewResultsGetValidateBeforeCall(
      ReviewElementPrereviewResultsGetRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    if (data == null) {
      throw new ApiException(
          "Missing the required parameter 'data' when calling reviewElementPrereviewResultsGet(Async)");
    }
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;ReviewElementPrereviewResultsGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
   ...
   */
  public okhttp3.Call reviewElementPrereviewResultsGetAsync(
      ReviewElementPrereviewResultsGetRequest data,
