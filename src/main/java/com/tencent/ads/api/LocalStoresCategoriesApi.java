...
public class LocalStoresCategoriesApi {
  private ApiClient apiClient;

  public LocalStoresCategoriesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public LocalStoresCategoriesApi(ApiClient apiClient) {
  ...
  /**
   * Build call for localStoresCategoriesGet
   *
  ...
  public okhttp3.Call localStoresCategoriesGetCall(
    ...
    String localVarPath = "/local_stores_categories/get";
   ...
   * @param verticalId (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;LocalStoresCategoriesGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
