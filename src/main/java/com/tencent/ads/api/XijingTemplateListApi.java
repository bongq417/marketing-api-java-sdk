...
public class XijingTemplateListApi {
   ...
   */
  public okhttp3.Call xijingTemplateListGetCall(
      Long accountId,
  ...
  private okhttp3.Call xijingTemplateListGetValidateBeforeCall(
      Long accountId,
      String pageTemplateId,
      Boolean isInteraction,
      Boolean isPublic,
   ...
   */
  public okhttp3.Call xijingTemplateListGetAsync(
      Long accountId,
      String pageTemplateId,
      Boolean isInteraction,
      Boolean isPublic,
