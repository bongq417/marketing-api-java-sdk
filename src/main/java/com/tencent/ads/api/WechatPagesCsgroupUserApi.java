...
public class WechatPagesCsgroupUserApi {
  private ApiClient apiClient;

  public WechatPagesCsgroupUserApi() {
    this(Configuration.getDefaultApiClient());
  }

  public WechatPagesCsgroupUserApi(ApiClient apiClient) {
  ...
  /**
   * Build call for wechatPagesCsgroupUserGet
   *
   ...
   */
  public okhttp3.Call wechatPagesCsgroupUserGetCall(
      Long accountId,
      String corpId,
      Long departmentId,
      List<String> fields,
    ...
    String localVarPath = "/wechat_pages_csgroup_user/get";
    ...
    if (departmentId != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("department_id", departmentId));
    if (fields != null)
  ...
  private okhttp3.Call wechatPagesCsgroupUserGetValidateBeforeCall(
      Long accountId,
      String corpId,
      Long departmentId,
      List<String> fields,
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling wechatPagesCsgroupUserGet(Async)");
    }

    // verify the required parameter 'corpId' is set
    if (corpId == null) {
      throw new ApiException(
          "Missing the required parameter 'corpId' when calling wechatPagesCsgroupUserGet(Async)");
    }
   ...
   * @param departmentId (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;WechatPagesCsgroupUserGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
   ...
   */
  public okhttp3.Call wechatPagesCsgroupUserGetAsync(
      Long accountId,
      String corpId,
      Long departmentId,
      List<String> fields,
