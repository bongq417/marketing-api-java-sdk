...
public class LocalStoresWxpayMerchantsApi {
  private ApiClient apiClient;

  public LocalStoresWxpayMerchantsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public LocalStoresWxpayMerchantsApi(ApiClient apiClient) {
  ...
  /**
   * Build call for localStoresWxpayMerchantsGet
   *
   ...
   */
  public okhttp3.Call localStoresWxpayMerchantsGetCall(
      Long accountId,
      Long page,
      Long pageSize,
      List<String> fields,
    ...
    String localVarPath = "/local_stores_wxpay_merchants/get";
  ...
  private okhttp3.Call localStoresWxpayMerchantsGetValidateBeforeCall(
      Long accountId,
      Long page,
      Long pageSize,
      List<String> fields,
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling localStoresWxpayMerchantsGet(Async)");
    }
   ...
   * @param pageSize (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;LocalStoresWxpayMerchantsGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
   ...
   */
  public okhttp3.Call localStoresWxpayMerchantsGetAsync(
      Long accountId,
      Long page,
      Long pageSize,
      List<String> fields,
