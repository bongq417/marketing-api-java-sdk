...
public class ProductsSystemStatusApi {
   ...
   */
  public okhttp3.Call productsSystemStatusGetCall(
      Long accountId,
  ...
  private okhttp3.Call productsSystemStatusGetValidateBeforeCall(
      Long accountId,
      Long productCatalogId,
      Long feedId,
      Long page,
   ...
   */
  public okhttp3.Call productsSystemStatusGetAsync(
      Long accountId,
      Long productCatalogId,
      Long feedId,
      Long page,
