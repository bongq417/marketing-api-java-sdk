...
public class CapabilitiesApi {
  ...
  public okhttp3.Call capabilitiesGetCall(
    ...
    String localVarPath = "/capabilities/get";
    ...
    if (capability != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("capability", capability));
    if (querySpec != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("query_spec", querySpec));
    if (fields != null)
  ...
  private okhttp3.Call capabilitiesGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling capabilitiesGet(Async)");
    }
   ...
   * @param querySpec (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;CapabilitiesGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
