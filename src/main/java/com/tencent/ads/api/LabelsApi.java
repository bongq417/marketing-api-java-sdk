...
public class LabelsApi {
  ...
  public okhttp3.Call labelsGetCall(
    ...
    String localVarPath = "/labels/get";
   ...
   *     response body
   */
  public LabelsGetResponse labelsGet(
      Long accountId,
      List<FilteringStruct> filtering,
      Long page,
      Long pageSize,
   ...
   * @param pageSize (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;LabelsGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  public ApiResponse<LabelsGetResponse> labelsGetWithHttpInfo(
      Long accountId,
      List<FilteringStruct> filtering,
      Long page,
      Long pageSize,
