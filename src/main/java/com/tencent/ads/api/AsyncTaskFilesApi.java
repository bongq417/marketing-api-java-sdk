...
public class AsyncTaskFilesApi {
  private ApiClient apiClient;

  public AsyncTaskFilesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public AsyncTaskFilesApi(ApiClient apiClient) {
  ...
  public okhttp3.Call asyncTaskFilesGetCall(
    ...
    String localVarPath = "/async_task_files/get";
  ...
  private okhttp3.Call asyncTaskFilesGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling asyncTaskFilesGet(Async)");
    }

    // verify the required parameter 'taskId' is set
    if (taskId == null) {
      throw new ApiException(
          "Missing the required parameter 'taskId' when calling asyncTaskFilesGet(Async)");
    }
