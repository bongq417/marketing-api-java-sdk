...
public class FundTransferApi {
   ...
   */
  public Call fundTransferAddCall(
  ...
  private okhttp3.Call fundTransferAddValidateBeforeCall(
      FundTransferAddRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
  ...
  public ApiResponse<FundTransferAddResponse> fundTransferAddWithHttpInfo(
    ...
    okhttp3.Call call = fundTransferAddValidateBeforeCall(data, null, null);
   ...
   */
  public okhttp3.Call fundTransferAddAsync(
