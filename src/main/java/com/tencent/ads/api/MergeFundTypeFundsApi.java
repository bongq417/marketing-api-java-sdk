...
public class MergeFundTypeFundsApi {
   ...
   */
  public okhttp3.Call mergeFundTypeFundsGetCall(
      Long accountId,
      List<String> fields,
  ...
  private okhttp3.Call mergeFundTypeFundsGetValidateBeforeCall(
      Long accountId,
      List<String> fields,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
   ...
   */
  public okhttp3.Call mergeFundTypeFundsGetAsync(
      Long accountId,
      List<String> fields,
