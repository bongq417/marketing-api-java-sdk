...
public class PagesApi {
   ...
   */
  public okhttp3.Call pagesGetCall(
      Long accountId,
   ...
   *     response body
   */
  public PagesGetResponse pagesGet(
      Long accountId,
      String promotedObjectType,
      List<FilteringStruct> filtering,
      Long page,
    ...
    ApiResponse<PagesGetResponse> resp =
        pagesGetWithHttpInfo(accountId, promotedObjectType, filtering, page, pageSize, fields);
    return resp.getData();
  }
   ...
   *     response body
   */
  public ApiResponse<PagesGetResponse> pagesGetWithHttpInfo(
      Long accountId,
      String promotedObjectType,
      List<FilteringStruct> filtering,
      Long page,
    ...
    okhttp3.Call call =
        pagesGetValidateBeforeCall(
            accountId, promotedObjectType, filtering, page, pageSize, fields, null, null);
   ...
   */
  public okhttp3.Call pagesGetAsync(
      Long accountId,
      String promotedObjectType,
      List<FilteringStruct> filtering,
      Long page,
