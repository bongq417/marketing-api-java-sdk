...
public class WeixinOfficialAccountsUpgradeStatusApi {
  private ApiClient apiClient;

  public WeixinOfficialAccountsUpgradeStatusApi() {
    this(Configuration.getDefaultApiClient());
  }

  public WeixinOfficialAccountsUpgradeStatusApi(ApiClient apiClient) {
  ...
  /**
   * Build call for weixinOfficialAccountsUpgradeStatusGet
   *
  ...
  public okhttp3.Call weixinOfficialAccountsUpgradeStatusGetCall(
    ...
    String localVarPath = "/weixin_official_accounts_upgrade_status/get";
   ...
   * @param accountId (required)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;WeixinOfficialAccountsUpgradeStatusGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
