...
public class VideomakerVideocapturesApi {
   ...
   */
  public okhttp3.Call videomakerVideocapturesAddCall(
      Long accountId,
      String videoId,
      File videoFile,
      String signature,
  ...
  private okhttp3.Call videomakerVideocapturesAddValidateBeforeCall(
      Long accountId,
      String videoId,
      File videoFile,
      String signature,
   ...
   */
  public okhttp3.Call videomakerVideocapturesAddAsync(
      Long accountId,
      String videoId,
      File videoFile,
      String signature,
