...
public class PlayablePagesApi {
  private ApiClient apiClient;

  public PlayablePagesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public PlayablePagesApi(ApiClient apiClient) {
   ...
   */
  public okhttp3.Call playablePagesAddCall(
      Long accountId,
    ...
    String localVarPath = "/playable_pages/add";
    ...
    if (playablePageName != null) localVarFormParams.put("playable_page_name", playablePageName);
    if (materialFile != null) localVarFormParams.put("material_file", materialFile);
  ...
  private okhttp3.Call playablePagesAddValidateBeforeCall(
      Long accountId,
      String playablePageName,
      File materialFile,
      final ProgressResponseBody.ProgressListener progressListener,
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling playablePagesAdd(Async)");
    }

    // verify the required parameter 'playablePageName' is set
    if (playablePageName == null) {
      throw new ApiException(
          "Missing the required parameter 'playablePageName' when calling playablePagesAdd(Async)");
    }

    // verify the required parameter 'materialFile' is set
    if (materialFile == null) {
      throw new ApiException(
          "Missing the required parameter 'materialFile' when calling playablePagesAdd(Async)");
    }
   ...
   * @param playablePageName (required)
   * @param materialFile (required)
   * @return ApiResponse&lt;PlayablePagesAddResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
   ...
   */
  public okhttp3.Call playablePagesAddAsync(
      Long accountId,
      String playablePageName,
      File materialFile,
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public okhttp3.Call playablePagesGetCall(
      Long accountId,
    ...
    // create path and map variables
    String localVarPath = "/playable_pages/get";
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call playablePagesGetValidateBeforeCall(
      Long accountId,
      List<FilteringStruct> filtering,
      Long page,
      Long pageSize,
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling playablePagesGet(Async)");
    }

    okhttp3.Call call =
        playablePagesGetCall(
            accountId,
            filtering,
            page,
            pageSize,
   ...
   *     response body
   */
  public PlayablePagesGetResponse playablePagesGet(
      Long accountId,
      List<FilteringStruct> filtering,
      Long page,
      Long pageSize,
   ...
   * @param pageSize (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;PlayablePagesGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  public ApiResponse<PlayablePagesGetResponse> playablePagesGetWithHttpInfo(
      Long accountId,
      List<FilteringStruct> filtering,
      Long page,
      Long pageSize,
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call playablePagesGetAsync(
      Long accountId,
      List<FilteringStruct> filtering,
      Long page,
      Long pageSize,
