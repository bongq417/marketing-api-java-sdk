...
public class BatchAsyncRequestsApi {
  private ApiClient apiClient;

  public BatchAsyncRequestsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public BatchAsyncRequestsApi(ApiClient apiClient) {
  ...
  /**
   * Build call for batchAsyncRequestsAdd
   *
   * @param data (required)
  ...
  public okhttp3.Call batchAsyncRequestsAddCall(
    ...
    String localVarPath = "/batch_async_requests/add";
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;BatchAsyncRequestsAddResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  /**
   * Build call for batchAsyncRequestsGet
   *
  ...
  public okhttp3.Call batchAsyncRequestsGetCall(
    ...
    // create path and map variables
    String localVarPath = "/batch_async_requests/get";
   ...
   * @param pageSize (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;BatchAsyncRequestsGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
