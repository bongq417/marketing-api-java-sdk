...
public class XijingDeriveTempTokenApi {
  private ApiClient apiClient;

  public XijingDeriveTempTokenApi() {
    this(Configuration.getDefaultApiClient());
  }

  public XijingDeriveTempTokenApi(ApiClient apiClient) {
  ...
  /**
   * Build call for xijingDeriveTempTokenGet
   *
   * @param data (required)
   ...
   */
  public okhttp3.Call xijingDeriveTempTokenGetCall(
    ...
    String localVarPath = "/xijing_derive_temp_token/get";
  ...
  private okhttp3.Call xijingDeriveTempTokenGetValidateBeforeCall(
      XijingDeriveTempTokenGetRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    if (data == null) {
      throw new ApiException(
          "Missing the required parameter 'data' when calling xijingDeriveTempTokenGet(Async)");
    }
   ...
   */
  public okhttp3.Call xijingDeriveTempTokenGetAsync(
      XijingDeriveTempTokenGetRequest data,
