...
import com.tencent.ads.model.DplabelAdLabelGetResponse;
...
public class DplabelAdLabelApi {
  private ApiClient apiClient;

  public DplabelAdLabelApi() {
    this(Configuration.getDefaultApiClient());
  }

  public DplabelAdLabelApi(ApiClient apiClient) {
  ...
  /**
   * Build call for dplabelAdLabelGet
   *
  ...
  public okhttp3.Call dplabelAdLabelGetCall(
    ...
    String localVarPath = "/dplabel_ad_label/get";
   ...
   *     response body
   */
  public DplabelAdLabelGetResponse dplabelAdLabelGet(Long accountId, List<String> fields)
      throws ApiException {
    ApiResponse<DplabelAdLabelGetResponse> resp = dplabelAdLabelGetWithHttpInfo(accountId, fields);
    return resp.getData();
  }
   ...
   * @param accountId (required)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;DplabelAdLabelGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
