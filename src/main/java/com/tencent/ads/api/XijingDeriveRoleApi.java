...
public class XijingDeriveRoleApi {
  private ApiClient apiClient;

  public XijingDeriveRoleApi() {
    this(Configuration.getDefaultApiClient());
  }

  public XijingDeriveRoleApi(ApiClient apiClient) {
  ...
  /**
   * Build call for xijingDeriveRoleGet
   *
   * @param data (required)
  ...
  public okhttp3.Call xijingDeriveRoleGetCall(
    ...
    String localVarPath = "/xijing_derive_role/get";
   ...
   *     response body
   */
  public XijingDeriveRoleGetResponse xijingDeriveRoleGet(XijingDeriveRoleGetRequest data)
      throws ApiException {
    ApiResponse<XijingDeriveRoleGetResponse> resp = xijingDeriveRoleGetWithHttpInfo(data);
    return resp.getData();
  }
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;XijingDeriveRoleGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
