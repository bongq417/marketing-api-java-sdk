...
public class QualificationsApi {
  ...
  public okhttp3.Call qualificationsGetCall(
    ...
    if (qualificationType != null)
      localVarQueryParams.addAll(
          apiClient.parameterToPair("qualification_type", qualificationType));
    if (filtering != null)
   ...
   *     response body
   */
  public QualificationsGetResponse qualificationsGet(
      Long accountId,
      String qualificationType,
      List<FilteringStruct> filtering,
      List<String> fields)
    ...
    ApiResponse<QualificationsGetResponse> resp =
        qualificationsGetWithHttpInfo(accountId, qualificationType, filtering, fields);
    return resp.getData();
  }
   ...
   *     response body
   */
  public ApiResponse<QualificationsGetResponse> qualificationsGetWithHttpInfo(
      Long accountId,
      String qualificationType,
      List<FilteringStruct> filtering,
      List<String> fields)
