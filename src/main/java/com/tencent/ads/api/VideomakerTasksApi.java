...
public class VideomakerTasksApi {
  private ApiClient apiClient;

  public VideomakerTasksApi() {
    this(Configuration.getDefaultApiClient());
  }

  public VideomakerTasksApi(ApiClient apiClient) {
  ...
  /**
   * Build call for videomakerTasksGet
   *
  ...
  public okhttp3.Call videomakerTasksGetCall(
    ...
    String localVarPath = "/videomaker_tasks/get";
  ...
  private okhttp3.Call videomakerTasksGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling videomakerTasksGet(Async)");
    }
   ...
   * @param taskId (required)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;VideomakerTasksGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
