...
public class MaterialLabelsApi {
   ...
   */
  public okhttp3.Call materialLabelsAddCall(
  ...
  private okhttp3.Call materialLabelsAddValidateBeforeCall(
      MaterialLabelsAddRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
  ...
  public ApiResponse<MaterialLabelsAddResponse> materialLabelsAddWithHttpInfo(
    ...
    okhttp3.Call call = materialLabelsAddValidateBeforeCall(data, null, null);
   ...
   */
  public okhttp3.Call materialLabelsAddAsync(
   ...
   * @throws ApiException If fail to serialize the request body object
   */
  public okhttp3.Call materialLabelsGetCall(
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call materialLabelsGetValidateBeforeCall(
      MaterialLabelsGetRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
  ...
  public ApiResponse<MaterialLabelsGetResponse> materialLabelsGetWithHttpInfo(
    ...
    okhttp3.Call call = materialLabelsGetValidateBeforeCall(data, null, null);
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public okhttp3.Call materialLabelsGetAsync(
