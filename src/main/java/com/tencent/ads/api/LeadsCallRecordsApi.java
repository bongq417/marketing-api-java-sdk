...
public class LeadsCallRecordsApi {
   ...
   *     response body
   */
  public LeadsCallRecordsGetResponse leadsCallRecordsGet(LeadsCallRecordsGetRequest data)
      throws ApiException {
    ApiResponse<LeadsCallRecordsGetResponse> resp = leadsCallRecordsGetWithHttpInfo(data);
    return resp.getData();
  }
