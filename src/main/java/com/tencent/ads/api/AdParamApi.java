...
public class AdParamApi {
   ...
   */
  public okhttp3.Call adParamGetCall(
  ...
  private okhttp3.Call adParamGetValidateBeforeCall(
      AdParamGetRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
    ...
    okhttp3.Call call = adParamGetCall(data, progressListener, progressRequestListener);
    return call;
  }
  ...
  public ApiResponse<AdParamGetResponse> adParamGetWithHttpInfo(AdParamGetRequest data)
      throws ApiException {
    okhttp3.Call call = adParamGetValidateBeforeCall(data, null, null);
   ...
   */
  public okhttp3.Call adParamGetAsync(
