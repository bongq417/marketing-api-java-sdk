...
import com.tencent.ads.model.DailyBalanceReportGetResponse;
...
public class DailyBalanceReportApi {
  private ApiClient apiClient;

  public DailyBalanceReportApi() {
    this(Configuration.getDefaultApiClient());
  }

  public DailyBalanceReportApi(ApiClient apiClient) {
  ...
  /**
   * Build call for dailyBalanceReportGet
   *
  ...
  public okhttp3.Call dailyBalanceReportGetCall(
    ...
    String localVarPath = "/daily_balance_report/get";
  ...
  private okhttp3.Call dailyBalanceReportGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling dailyBalanceReportGet(Async)");
    }
   ...
   * @param pageSize (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;DailyBalanceReportGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  /**
   * 获取资金账户日结明细（新，包含日终结余数据） (asynchronously)
   *
   * @param accountId (required)
   * @param dateRange (required)
   * @param page (optional)
