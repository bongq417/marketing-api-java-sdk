...
public class ProductCatalogsReportsApi {
  private ApiClient apiClient;

  public ProductCatalogsReportsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public ProductCatalogsReportsApi(ApiClient apiClient) {
  ...
  public okhttp3.Call productCatalogsReportsGetCall(
    ...
    String localVarPath = "/product_catalogs_reports/get";
  ...
  private okhttp3.Call productCatalogsReportsGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling productCatalogsReportsGet(Async)");
    }

    // verify the required parameter 'productCatalogId' is set
    if (productCatalogId == null) {
      throw new ApiException(
          "Missing the required parameter 'productCatalogId' when calling productCatalogsReportsGet(Async)");
    }
   ...
   *     response body
   */
  public ProductCatalogsReportsGetResponse productCatalogsReportsGet(
      Long accountId,
      Long productCatalogId,
      ReportDateRange dateRange,
      List<FilteringStruct> filtering,
   ...
   * @param orderBy (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;ProductCatalogsReportsGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  public ApiResponse<ProductCatalogsReportsGetResponse> productCatalogsReportsGetWithHttpInfo(
      Long accountId,
      Long productCatalogId,
      ReportDateRange dateRange,
      List<FilteringStruct> filtering,
