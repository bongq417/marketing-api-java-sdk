...
public class AdDiagnosisApi {
   ...
   *     response body
   */
  public AdDiagnosisGetResponse adDiagnosisGet(AdDiagnosisGetRequest data) throws ApiException {
    ApiResponse<AdDiagnosisGetResponse> resp = adDiagnosisGetWithHttpInfo(data);
    return resp.getData();
  }
