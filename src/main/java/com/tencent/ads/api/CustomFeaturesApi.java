...
public class CustomFeaturesApi {
  private ApiClient apiClient;

  public CustomFeaturesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public CustomFeaturesApi(ApiClient apiClient) {
  ...
  public okhttp3.Call customFeaturesGetCall(
    ...
    String localVarPath = "/custom_features/get";
   ...
   *     response body
   */
  public CustomFeaturesGetResponse customFeaturesGet(
      Long accountId,
      List<FilteringStruct> filtering,
      Long page,
      Long pageSize,
      List<String> fields)
      throws ApiException {
    ApiResponse<CustomFeaturesGetResponse> resp =
        customFeaturesGetWithHttpInfo(accountId, filtering, page, pageSize, fields);
    return resp.getData();
  }
   ...
   * @param pageSize (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;CustomFeaturesGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  public ApiResponse<CustomFeaturesGetResponse> customFeaturesGetWithHttpInfo(
      Long accountId,
      List<FilteringStruct> filtering,
      Long page,
      Long pageSize,
