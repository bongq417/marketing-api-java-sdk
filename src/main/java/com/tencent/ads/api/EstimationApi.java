...
public class EstimationApi {
  ...
  public okhttp3.Call estimationGetCall(
    ...
    String localVarPath = "/estimation/get";
   ...
   *     response body
   */
  public EstimationGetResponse estimationGet(EstimationGetRequest data) throws ApiException {
    ApiResponse<EstimationGetResponse> resp = estimationGetWithHttpInfo(data);
    return resp.getData();
  }
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;EstimationGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
