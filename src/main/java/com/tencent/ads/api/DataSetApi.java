...
public class DataSetApi {
  ...
  public okhttp3.Call dataSetAddCall(
    ...
    String localVarPath = "/data_set/add";
   ...
   *
   * @param data (required)
   * @return ApiResponse&lt;DataSetAddResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  public okhttp3.Call dataSetGetCall(
    ...
    // create path and map variables
    String localVarPath = "/data_set/get";
    ...
    if (dataSetId != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("data_set_id", dataSetId));
    if (envType != null) localVarQueryParams.addAll(apiClient.parameterToPair("env_type", envType));
    if (fields != null)
   ...
   * @param envType (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;DataSetGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
