...
public class BusinessMdmAccountRelationsApi {
  private ApiClient apiClient;

  public BusinessMdmAccountRelationsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public BusinessMdmAccountRelationsApi(ApiClient apiClient) {
  ...
  /**
   * Build call for businessMdmAccountRelationsGet
   *
  ...
  public okhttp3.Call businessMdmAccountRelationsGetCall(
    ...
    String localVarPath = "/business_mdm_account_relations/get";
    ...
    if (relationType != null)
      localVarQueryParams.addAll(apiClient.parameterToPair("relation_type", relationType));
  ...
  private okhttp3.Call businessMdmAccountRelationsGetValidateBeforeCall(
    ...
    if (accountId == null) {
      throw new ApiException(
          "Missing the required parameter 'accountId' when calling businessMdmAccountRelationsGet(Async)");
    }
   ...
   * @param pageSize (optional)
   * @param fields 返回参数的字段列表 (optional)
   * @return ApiResponse&lt;BusinessMdmAccountRelationsGetResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   */
  ...
  /**
   * 查询商务管家或同主体下广告主信息 (asynchronously)
   *
   * @param accountId (required)
   * @param relationType (required)
   * @param page (optional)
