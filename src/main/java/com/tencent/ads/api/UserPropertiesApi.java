...
public class UserPropertiesApi {
   ...
   */
  public okhttp3.Call userPropertiesAddCall(
  ...
  private okhttp3.Call userPropertiesAddValidateBeforeCall(
      UserPropertiesAddRequest data,
      final ProgressResponseBody.ProgressListener progressListener,
      final ProgressRequestBody.ProgressRequestListener progressRequestListener)
      throws ApiException {
  ...
  public ApiResponse<UserPropertiesAddResponse> userPropertiesAddWithHttpInfo(
    ...
    okhttp3.Call call = userPropertiesAddValidateBeforeCall(data, null, null);
   ...
   */
  public okhttp3.Call userPropertiesAddAsync(
